                    ...
                    <span class="dropdown">
                        ...
                        <ul>
                            ...
                            <?php if ($this->projectRole->canCreateTaskInColumn($column['project_id'], $column['id'])): ?>
                            	...
                            	<li>
				    <?= $this->modal->medium('edit', t('Edit'), 'ColumnController', 'edit', array('project_id' => $column['project_id'], 'column_id' => $column['id'])) ?>
				</li>
                                <?php if ($column['nb_open_tasks'] == 0 && $column['nb_closed_tasks'] == 0): ?>
                                  <li>
                                      <?= $this->modal->confirm('trash-o', t('Remove'), 'ColumnController', 'confirm', array('project_id' => $column['project_id'], 'column_id' => $column['id'])) ?>
                                  </li>
                                <?php endif ?>
                            <?php endif ?>
